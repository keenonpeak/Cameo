...
namespace Cameo
{
    public class XAPI_open_story : IBehaviourLogHandler
	{
		public BehaviourLogBase CreateLog()
		{
			...
			behaviourLog.AddElement("object.id", BehaviourType.open_story.ToString());
			...
			behaviourLog.AddElement("object.definition.description.zh-TW", GetBehaviourDescription(BehaviourType.open_story));
