...
namespace Cameo
{
    public class XAPI_switch_illustration_hall : IBehaviourLogHandler
    {
        public BehaviourLogBase CreateLog()
        {
            ...
            behaviourLog.AddElement("object.id", BehaviourType.switch_illustration_hall.ToString());
            behaviourLog.AddElement("object.definition.category.zh-TW", "互動圖鑑");
            behaviourLog.AddElement("object.definition.name.zh-TW", GetBehaviourName(BehaviourType.switch_illustration_hall));
            behaviourLog.AddElement("object.definition.description.zh-TW", GetBehaviourDescription(BehaviourType.switch_illustration_hall));
