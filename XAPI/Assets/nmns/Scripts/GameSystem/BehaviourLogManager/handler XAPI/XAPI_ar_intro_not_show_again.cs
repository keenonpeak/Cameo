...
namespace Cameo
{
    public class XAPI_ar_intro_not_show_again : IBehaviourLogHandler
    {
        public BehaviourLogBase CreateLog()
        {
            ...
            behaviourLog.AddElement("object.id", BehaviourType.ar_intro_not_show_again.ToString());
            behaviourLog.AddElement("object.definition.category.zh-TW", "互動圖鑑");
            behaviourLog.AddElement("object.definition.name.zh-TW", GetBehaviourName(BehaviourType.ar_intro_not_show_again));
            behaviourLog.AddElement("object.definition.description.zh-TW", GetBehaviourDescription(BehaviourType.ar_intro_not_show_again));
