...
namespace Cameo
{
    public class XAPI_start_vr : IBehaviourLogHandler
    {
        public BehaviourLogBase CreateLog()
        {
            ...
            behaviourLog.AddElement("object.id", BehaviourType.start_vr.ToString());
            behaviourLog.AddElement("object.definition.category.zh-TW", "互動圖鑑");
            behaviourLog.AddElement("object.definition.name.zh-TW", GetBehaviourName(BehaviourType.start_vr));
            behaviourLog.AddElement("object.definition.description.zh-TW", GetBehaviourDescription(BehaviourType.start_vr));
