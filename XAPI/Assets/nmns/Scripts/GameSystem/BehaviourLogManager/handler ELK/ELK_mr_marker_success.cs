...
namespace Cameo
{
    public class ELK_mr_marker_success : IBehaviourLogHandler
    {
        public BehaviourLogBase CreateLog()
        {
            BehaviourLogELK behaviourLog = new BehaviourLogELK();

            behaviourLog.AddElement("strCategory", BehaviourType.mr_marker_success.ToString());
            ...
            string actionLog = string.Format(GetBehaviourReferenceFormat(BehaviourType.mr_marker_success), selectedMrName, selectedMrAnchor, time);
