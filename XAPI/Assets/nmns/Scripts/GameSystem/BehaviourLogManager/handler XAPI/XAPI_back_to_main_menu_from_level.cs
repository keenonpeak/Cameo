...
namespace Cameo
{
    public class XAPI_back_to_main_menu_from_level : IBehaviourLogHandler
    {
        public BehaviourLogBase CreateLog()
        {
            ...
            behaviourLog.AddElement("object.id", BehaviourType.back_to_main_menu_from_level.ToString());
            behaviourLog.AddElement("object.definition.category.zh-TW", "遊戲主題");
            behaviourLog.AddElement("object.definition.name.zh-TW", GetBehaviourName(BehaviourType.back_to_main_menu_from_level));
            behaviourLog.AddElement("object.definition.description.zh-TW", GetBehaviourDescription(BehaviourType.back_to_main_menu_from_level));
