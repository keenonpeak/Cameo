...
namespace Cameo
{
    public class ELK_mr_interact_success : IBehaviourLogHandler
    {
        public BehaviourLogBase CreateLog()
        {
            BehaviourLogELK behaviourLog = new BehaviourLogELK();

            behaviourLog.AddElement("strCategory", BehaviourType.mr_interact_success.ToString());
            ...
            string actionLog = string.Format(GetBehaviourReferenceFormat(BehaviourType.mr_interact_success), selectedMrName, selectedMrAnchor, time);
